...
// (unit-tested); getJson/postJson use Node's global fetch with a short timeout, and
// NEVER throw — a dead surface resolves to null so the caller can flag status. ESM.
...
// Writes are fire-and-forget on the app side (HTTP 202). We still return the parsed
// body so an action can log it, but a 202 with ok:true is success.
